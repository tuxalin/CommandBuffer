...
harfbuzz_debug_common_cflags  += -m64
...
harfbuzz_debug_common_cflags  += -funwind-tables -Wall -Wextra -Wno-unused-parameter -Wno-ignored-qualifiers -Wno-unused-but-set-variable -Wno-switch -Wno-unused-variable -Wno-unused-function -malign-double
harfbuzz_debug_common_cflags  += -m64 -pthread
...
harfbuzz_debug_lflags  += -Wl,--unresolved-symbols=ignore-in-shared-libs
harfbuzz_debug_lflags  += -m64 -pthread
harfbuzz_debug_lflags  += -m64
...
harfbuzz_debug_bin      := ./../../lib/linux64/libharfbuzzD.a
...
$(harfbuzz_debug_bin): $(harfbuzz_debug_obj) 
	mkdir -p `dirname ./../../lib/linux64/libharfbuzzD.a`
...
harfbuzz_release_common_cflags  += -m64
...
harfbuzz_release_common_cflags  += -funwind-tables -Wall -Wextra -Wno-unused-parameter -Wno-ignored-qualifiers -Wno-unused-but-set-variable -Wno-switch -Wno-unused-variable -Wno-unused-function -malign-double
harfbuzz_release_common_cflags  += -m64 -pthread
...
harfbuzz_release_lflags  += -Wl,--unresolved-symbols=ignore-in-shared-libs
harfbuzz_release_lflags  += -m64 -pthread
harfbuzz_release_lflags  += -m64
...
harfbuzz_release_bin      := ./../../lib/linux64/libharfbuzz.a
...
$(harfbuzz_release_bin): $(harfbuzz_release_obj) 
	mkdir -p `dirname ./../../lib/linux64/libharfbuzz.a`
