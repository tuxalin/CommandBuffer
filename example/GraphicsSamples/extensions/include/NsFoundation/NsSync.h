...
#ifndef NV_NSFOUNDATION_NSSYNC_H
#define NV_NSFOUNDATION_NSSYNC_H
...
*/
class NV_FOUNDATION_API SyncImpl
{
  public:
...
class SyncT : protected Alloc
{
  public:
	...
	SyncT(const Alloc& alloc = Alloc()) : Alloc(alloc)
	{
		...
		NV_PLACEMENT_NEW(mImpl, SyncImpl)();
	}
...
#endif // #ifndef NV_NSFOUNDATION_NSSYNC_H
