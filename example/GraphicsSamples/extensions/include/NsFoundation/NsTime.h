...
#ifndef NV_NSFOUNDATION_NSTIME_H
#define NV_NSFOUNDATION_NSTIME_H

#include "Ns.h"

#if NV_LINUX || NV_ANDROID
#include <time.h>
#endif
...
class NV_FOUNDATION_API Time
{
  ...
  private:
#if NV_LINUX || NV_ANDROID || NV_APPLE_FAMILY || NV_PSP2 || NV_PS4
	Second mLastTime;
#else
	int64_t mTickCount;
#endif
...
#endif // #ifndef NV_NSFOUNDATION_NSTIME_H
