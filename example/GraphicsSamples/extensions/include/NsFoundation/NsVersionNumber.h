...
#ifndef NV_NSFOUNDATION_NSVERSIONNUMBER_H
#define NV_NSFOUNDATION_NSVERSIONNUMBER_H
...
#define NV_FOUNDATION_VERSION_MAJOR 3
#define NV_FOUNDATION_VERSION_MINOR 4
#define NV_FOUNDATION_VERSION_BUGFIX 0

/**
The constant NV_FOUNDATION_VERSION is used when creating certain PhysX module objects.
...
#define NV_FOUNDATION_VERSION                                                                                          \
	((NV_FOUNDATION_VERSION_MAJOR << 24) + (NV_FOUNDATION_VERSION_MINOR << 16) + (NV_FOUNDATION_VERSION_BUGFIX << 8) + 0)

#endif // NV_FOUNDATION_NV_VERSION_NUMBER_H
