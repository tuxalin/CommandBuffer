...
NvModel_debug_common_cflags  += -funwind-tables -Wall -Wextra -Wno-unused-parameter -Wno-ignored-qualifiers -Wno-unused-but-set-variable -Wno-switch -Wno-unused-variable -Wno-unused-function -pthread
...
NvModel_debug_cppflags  += -Wno-reorder
...
NvModel_debug_lflags  += -Wl,--unresolved-symbols=ignore-in-shared-libs -pthread
...
NvModel_debug_bin      := ./../../lib/linux-aarch64/libNvModelD.a
...
$(NvModel_debug_bin): $(NvModel_debug_obj) 
	mkdir -p `dirname ./../../lib/linux-aarch64/libNvModelD.a`
...
NvModel_release_common_cflags  += -funwind-tables -Wall -Wextra -Wno-unused-parameter -Wno-ignored-qualifiers -Wno-unused-but-set-variable -Wno-switch -Wno-unused-variable -Wno-unused-function -pthread
...
NvModel_release_cppflags  += -Wno-reorder
...
NvModel_release_lflags  += -Wl,--unresolved-symbols=ignore-in-shared-libs -pthread
...
NvModel_release_bin      := ./../../lib/linux-aarch64/libNvModel.a
...
$(NvModel_release_bin): $(NvModel_release_obj) 
	mkdir -p `dirname ./../../lib/linux-aarch64/libNvModel.a`
