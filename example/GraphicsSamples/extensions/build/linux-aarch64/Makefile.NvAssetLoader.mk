...
NvAssetLoader_debug_common_cflags  += -funwind-tables -Wall -Wextra -Wno-unused-parameter -Wno-ignored-qualifiers -Wno-unused-but-set-variable -Wno-switch -Wno-unused-variable -Wno-unused-function -pthread
...
NvAssetLoader_debug_lflags  += -Wl,--unresolved-symbols=ignore-in-shared-libs -pthread
...
NvAssetLoader_debug_bin      := ./../../lib/linux-aarch64/libNvAssetLoaderD.a
...
$(NvAssetLoader_debug_bin): $(NvAssetLoader_debug_obj) 
	mkdir -p `dirname ./../../lib/linux-aarch64/libNvAssetLoaderD.a`
...
NvAssetLoader_release_common_cflags  += -funwind-tables -Wall -Wextra -Wno-unused-parameter -Wno-ignored-qualifiers -Wno-unused-but-set-variable -Wno-switch -Wno-unused-variable -Wno-unused-function -pthread
...
NvAssetLoader_release_lflags  += -Wl,--unresolved-symbols=ignore-in-shared-libs -pthread
...
NvAssetLoader_release_bin      := ./../../lib/linux-aarch64/libNvAssetLoader.a
...
$(NvAssetLoader_release_bin): $(NvAssetLoader_release_obj) 
	mkdir -p `dirname ./../../lib/linux-aarch64/libNvAssetLoader.a`
