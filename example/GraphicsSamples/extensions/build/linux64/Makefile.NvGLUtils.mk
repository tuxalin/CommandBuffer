...
NvGLUtils_debug_common_cflags  += -funwind-tables -Wall -Wextra -Wno-unused-parameter -Wno-ignored-qualifiers -Wno-unused-but-set-variable -Wno-switch -Wno-unused-variable -Wno-unused-function -malign-double
NvGLUtils_debug_common_cflags  += -m64 -pthread
...
NvGLUtils_debug_lflags  += -Wl,--unresolved-symbols=ignore-in-shared-libs
NvGLUtils_debug_lflags  += -m64 -pthread
...
NvGLUtils_debug_bin      := ./../../lib/linux64/libNvGLUtilsD.a
...
$(NvGLUtils_debug_bin): $(NvGLUtils_debug_obj) 
	mkdir -p `dirname ./../../lib/linux64/libNvGLUtilsD.a`
...
NvGLUtils_release_common_cflags  += -funwind-tables -Wall -Wextra -Wno-unused-parameter -Wno-ignored-qualifiers -Wno-unused-but-set-variable -Wno-switch -Wno-unused-variable -Wno-unused-function -malign-double
NvGLUtils_release_common_cflags  += -m64 -pthread
...
NvGLUtils_release_lflags  += -Wl,--unresolved-symbols=ignore-in-shared-libs
NvGLUtils_release_lflags  += -m64 -pthread
...
NvGLUtils_release_bin      := ./../../lib/linux64/libNvGLUtils.a
...
$(NvGLUtils_release_bin): $(NvGLUtils_release_obj) 
	mkdir -p `dirname ./../../lib/linux64/libNvGLUtils.a`
